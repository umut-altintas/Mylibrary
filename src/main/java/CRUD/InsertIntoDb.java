...
public class InsertIntoDb {
    ...
    public static void finishedBook(String url, int book_id, int book_score, String book_summary){
        String sql = "INSERT INTO finished_books(book_id, book_finished_date, book_read_time, book_score, book_summary) VALUES (?,?,?,?,?)";
